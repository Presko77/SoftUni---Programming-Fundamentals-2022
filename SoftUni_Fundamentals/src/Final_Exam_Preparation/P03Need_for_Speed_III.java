...
public class P03Need_for_Speed_III {
    public static void main(String[] args) {
        ...
        while (!inputLine.equals("Stop")) {
            ...
            switch (command) {
                case "Drive":
                    ...
                    consumedFuel = Integer.parseInt(tokens[3]);
                    ...
                    break;
                case "Refuel":
                    consumedFuel = Integer.parseInt(tokens[2]);
                    int totalFuel = fuel + consumedFuel;
                    int diff = 0;
                    if (totalFuel > 75) {
                        diff = 75 - fuel;
                        totalFuel = 75;
        ...
        carsMap.forEach((key, value) -> System.out.printf("%s -> Mileage: %d kms, Fuel in the tank: %d lt.%n",
